    ...
    for i in all_clusters:
        ...
        summary = model.generate(
            messages=[
                # {
                #     "role": "system",
                #     "content": "You are expert at english language summarizing long documents on consice way ",
                # },
                {
                    "role": "user",
                    "content": template.format(context=formatted_txt),
                }
            ],
